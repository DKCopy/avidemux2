...
ELSE()
        ...
        SET(ADM_CPU_X86 1)
        SET(ADM_CPU_X86_64 1)
		ADD_COMPILE_OPTIONS("$<$<COMPILE_LANGUAGE:C,CXX>:/F40000000>" "$<$<COMPILE_LANGUAGE:C,CXX>:-D__STDC_LIMIT_MACROS>") # increase stack size to 4M, linux32 is 2 MB by default, MS is 1MB by default
ENDIF()
